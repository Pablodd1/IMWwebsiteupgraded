...
const dictionaries = {
  en: {
    ...
    blogs: {
      ...
      'Hormone-Replacement-Therapy': () => import('./en/blogs/Hormone Replacement Therapy.json'),
      'Testosterone': () => import('./en/blogs/Testosterone Therapy for Men.json'),
      ...
      'Vagus-Nerve-Stimulation': () => import('./en/blogs/Vagus Nerve Stimulation.json'),
      'Personalized-Wellness': () => import('./en/blogs/Personalized Wellness Programs.json'),
      ...
      'Post-Concussion-Syndrome-Treatment': () => import('./en/blogs/Post-Concussion-Syndrome-Treatment.json'),
      'spinal-decompression': () => import('./en/blogs/spinal-decompression.json'),
      'chiropractic-adjustments': () => import('./en/blogs/chiropractic-adjustments.json'),
      'posture-correction-therapy': () => import('./en/blogs/posture-correction-therapy.json'),
      'shockwave-and-laser-therapy': () => import('./en/blogs/shockwave-and-laser-therapy.json'),
      'IV-Micronutrient-Therapy': () => import('./en/blogs/IV-Micronutrient-Therapy.json'),
      'NAD-Therapy': () => import('./en/blogs/NAD-Therapy.json'),
      'Custom-Blends': () => import('./en/blogs/Custom Blends.json'),
      'Performance-Booster-IVs': () => import('./en/blogs/Performance Booster IVs.json'),
      'Post-MVA-Concussion-Treatment': () => import('./en/blogs/Post-MVA-Concussion-Treatment.json'),
      'medical-notes': () => import('./en/blogs/medical-notes.json'),
      'Injury-Rehabilitation': () => import('./en/blogs/Injury-Rehabilitation.json'),
  ...
  es: {
    ...
    blogs: {
      ...
      'Hormone-Replacement-Therapy': () => import('./es/blogs/Hormone Replacement Therapy.json'),
      'Testosterone': () => import('./es/blogs/Testosterone Therapy for Men.json'),
      ...
      'Vagus-Nerve-Stimulation': () => import('./es/blogs/Vagus Nerve Stimulation.json'),
      'Personalized-Wellness': () => import('./es/blogs/Personalized Wellness Programs.json'),
      ...
      'Post-Concussion-Syndrome-Treatment': () => import('./es/blogs/Post-Concussion-Syndrome-Treatment.json'),
      'spinal-decompression': () => import('./es/blogs/spinal-decompression.json'),
      'chiropractic-adjustments': () => import('./es/blogs/chiropractic-adjustments.json'),
      'posture-correction-therapy': () => import('./es/blogs/posture-correction-therapy.json'),
      'shockwave-and-laser-therapy': () => import('./es/blogs/shockwave-and-laser-therapy.json'),
      'IV-Micronutrient-Therapy': () => import('./es/blogs/IV-Micronutrient-Therapy.json'),
      'NAD-Therapy': () => import('./es/blogs/NAD-Therapy.json'),
      'Custom-Blends': () => import('./es/blogs/Custom Blends.json'),
      'Performance-Booster-IVs': () => import('./es/blogs/Performance Booster IVs.json'),
      'Post-MVA-Concussion-Treatment': () => import('./es/blogs/Post-MVA-Concussion-Treatment.json'),
      'medical-notes': () => import('./es/blogs/medical-notes.json'),
      'Injury-Rehabilitation': () => import('./es/blogs/Injury-Rehabilitation.json'),
